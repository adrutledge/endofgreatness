...
- **Contract duration**: most contracts span full months (1–6 months, weighted toward 1–3); occasionally an emergency contract with duration of days to a few weeks appears on the board; emergency contracts tend to offer Independent command rights and better salvage/pay than standard contracts of similar difficulty, but have a wider difficulty window (easier or harder than expected) reflecting the employer's desperation and incomplete intelligence; emergency contracts expire faster (fewer ticks before removal)
